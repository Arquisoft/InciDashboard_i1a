...
public class EntityTests {
	...
	public void PR01() {
		...
		agent2.setUserName("fernando");
		Assert.assertFalse(agent.equals(agent2));
		Assert.assertEquals("alejandro", agent.getUserName());
		Assert.assertEquals("123456", agent.getPassword());
		agent.setUserName("noalejandro");
		Assert.assertEquals("noalejandro", agent.getUserName());
